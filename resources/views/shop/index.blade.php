            ...
            <article class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                @php
                    $badgeClass = match($product->category) {
                        'Cursus'     => 'bg-emerald-100 text-emerald-800',
                        'DIY-pakket' => 'bg-amber-100 text-amber-800',
                ...
                <p class="mt-4 text-lg font-bold text-slate-900">&euro;&nbsp;{{ number_format($product->price, 2, ',', '.') }}</p>
